.class public Lcom/android/settings/network/telephony/g0;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/network/telephony/g0;->a:Landroid/graphics/drawable/Drawable;
...
.method public static A(Landroid/content/Context;I)Z
    ...
    .line 1
    :cond_0
    invoke-static {p0, p1}, Lcom/android/settings/network/telephony/g0;->z(Landroid/content/Context;I)Z
    ...
    .line 5
    invoke-static {v1}, Lcom/android/settings/network/telephony/g0;->k(I)I

    move-result v1

    .line 6
    invoke-static {p0, p1}, Lcom/android/settings/network/telephony/g0;->F(Landroid/content/Context;I)Z
    ...
    .line 7
    :cond_2
    invoke-static {p0, p1}, Lcom/android/settings/network/telephony/g0;->L(Landroid/content/Context;I)Z
...
.method public static C(Landroid/content/Context;I)Z
    ...
    .line 3
    invoke-static {p0, p1}, Lcom/android/settings/network/telephony/g0;->D(Landroid/content/Context;Landroid/telephony/TelephonyManager;)Z
...
.method public static D(Landroid/content/Context;Landroid/telephony/TelephonyManager;)Z
    .locals 5
...
.method public static E(Landroid/content/Context;ILo2/k;Landroid/telecom/PhoneAccountHandle;)Z
    .locals 0
    ...
    .line 3
    invoke-static {p0, p3}, Lcom/android/settings/network/telephony/g0;->d(Landroid/content/Context;Landroid/telecom/PhoneAccountHandle;)Landroid/content/Intent;
    ...
    invoke-direct {p2, p0, p1}, Lo2/k;-><init>(Landroid/content/Context;I)V

    .line 5
    :cond_3
    invoke-virtual {p2}, Lo2/k;->h()Z
...
.method public static synthetic G(Landroid/content/Context;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
    .end annotation

    .line 1
    invoke-static {p0}, Lcom/android/settings/network/telephony/g0;->N(Landroid/content/Context;)Ljava/lang/Boolean;
...
.method public static H(Landroid/telephony/ims/ImsManager;IZ)V
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lcom/android/settings/network/telephony/g0;->j(Landroid/telephony/ims/ImsManager;I)Landroid/telephony/ims/ImsRcsManager;
...
.method public static I(Landroid/content/Context;IZZ)V
    .locals 2
...
.method public static L(Landroid/content/Context;I)Z
    ...
    .line 5
    :cond_0
    invoke-static {p0, p1}, Lcom/android/settings/network/telephony/g0;->C(Landroid/content/Context;I)Z
...
.method public static M(Landroid/content/Context;)Z
    ...
    .line 2
    :try_start_0
    new-instance v2, Lcom/android/settings/network/telephony/f0;

    invoke-direct {v2, p0}, Lcom/android/settings/network/telephony/f0;-><init>(Landroid/content/Context;)V
...
.method public static N(Landroid/content/Context;)Ljava/lang/Boolean;
    ...
    .line 15
    invoke-static {p0}, Lcom/android/settings/network/telephony/g0;->x(Landroid/content/Context;)Z
...
.method public static synthetic a(Landroid/content/Context;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lcom/android/settings/network/telephony/g0;->G(Landroid/content/Context;)Ljava/lang/Object;
...
.method public static c(Landroid/content/Context;Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;)Landroid/content/Intent;
    .locals 2
...
.method public static d(Landroid/content/Context;Landroid/telecom/PhoneAccountHandle;)Landroid/content/Intent;
    .locals 1

    const-string v0, "android.telecom.action.CONFIGURE_PHONE_ACCOUNT"

    .line 1
    invoke-static {p0, p1, v0}, Lcom/android/settings/network/telephony/g0;->c(Landroid/content/Context;Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;)Landroid/content/Intent;
...
.method public static g(Landroid/content/Context;ILcom/android/settings/network/telephony/v0;)I
    .locals 3
    ...
    .line 1
    invoke-interface {p2, p1}, Lcom/android/settings/network/telephony/v0;->getAvailabilityStatus(I)I
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lcom/android/settings/network/telephony/g0;->e(Landroid/content/Context;)[I
    ...
    .line 4
    invoke-interface {p2, v0}, Lcom/android/settings/network/telephony/v0;->getAvailabilityStatus(I)I
    ...
    .line 6
    invoke-interface {p2, v2}, Lcom/android/settings/network/telephony/v0;->getAvailabilityStatus(I)I
    ...
    invoke-interface {p2, p0}, Lcom/android/settings/network/telephony/v0;->getAvailabilityStatus(I)I
...
.method public static h(Landroid/content/Context;)Ljava/lang/CharSequence;
    .locals 2
    ...
    .line 3
    invoke-static {v0, v1}, Lcom/android/settings/network/telephony/g0;->s(Landroid/telephony/SubscriptionManager;I)Landroid/telephony/SubscriptionInfo;
    ...
    .line 5
    :cond_0
    invoke-static {p0}, Lcom/android/settings/network/telephony/g0;->l(Landroid/content/Context;)Ljava/lang/String;
...
.method public static i(Landroid/content/Context;I)Ljava/lang/CharSequence;
    ...
    .line 2
    invoke-static {v0, p1}, Lcom/android/settings/network/telephony/g0;->s(Landroid/telephony/SubscriptionManager;I)Landroid/telephony/SubscriptionInfo;
...
.method public static j(Landroid/telephony/ims/ImsManager;I)Landroid/telephony/ims/ImsRcsManager;
    .locals 2
...
.method public static k(I)I
    ...
    .line 1
    invoke-static {p0}, Lcom/android/settings/network/telephony/g0;->f(I)I
...
.method public static m(Landroid/content/Context;Landroid/telephony/SubscriptionInfo;)Ljava/lang/CharSequence;
    .locals 1
    ...
    .line 3
    invoke-static {p0, p1}, Lcom/android/settings/network/telephony/g0;->J(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static n(Landroid/content/Context;Landroid/telephony/SubscriptionInfo;)Ljava/lang/CharSequence;
    .locals 1
...
.method public static o(Landroid/content/Context;Landroid/telephony/SubscriptionManager;Z)Ljava/lang/CharSequence;
    .locals 7
    ...
    .line 8
    invoke-static {p0, v2}, Lcom/android/settings/network/telephony/g0;->m(Landroid/content/Context;Landroid/telephony/SubscriptionInfo;)Ljava/lang/CharSequence;
    ...
    .line 9
    :cond_2
    invoke-static {p0, v2}, Lcom/android/settings/network/telephony/g0;->n(Landroid/content/Context;Landroid/telephony/SubscriptionInfo;)Ljava/lang/CharSequence;
...
.method public static r(Landroid/content/Context;IIIZ)Landroid/graphics/drawable/Drawable;
    .locals 1

    .line 1
    new-instance v0, Lw4/a;

    invoke-direct {v0, p0}, Lw4/a;-><init>(Landroid/content/Context;)V

    .line 2
    invoke-static {p1, p2, p4}, Lw4/a;->i(IIZ)I
    ...
    .line 4
    sget-object p1, Lcom/android/settings/network/telephony/g0;->a:Landroid/graphics/drawable/Drawable;
    ...
    .line 11
    invoke-static {p0, p1}, La4/w;->o(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public static s(Landroid/telephony/SubscriptionManager;I)Landroid/telephony/SubscriptionInfo;
    .locals 3
...
.method public static u(Landroid/content/Context;I)Z
    ...
    .line 3
    invoke-static {p0, p1}, Lcom/android/settings/network/telephony/g0;->v(Landroid/telephony/ims/ImsManager;I)Z
...
.method public static v(Landroid/telephony/ims/ImsManager;I)Z
    .locals 2
