.class public Lcom/android/settings/notification/zen/g;
.super Lj4/a;
...
.field public f:Lcom/android/settingslib/applications/ApplicationsState$Session;

.field public g:Landroidx/fragment/app/Fragment;

.field public final h:Lcom/android/settingslib/applications/ApplicationsState$z;
...
.method public static constructor <clinit>()V
    ...
    .line 1
    invoke-static {v0}, Lcom/android/settings/notification/zen/g;->R(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/settings/notification/zen/g;->i:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Application;Landroidx/fragment/app/Fragment;Lcom/android/settings/notification/a;)V
    ...
    :goto_0
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/settings/notification/zen/g;-><init>(Landroid/content/Context;Lcom/android/settingslib/applications/ApplicationsState;Landroidx/fragment/app/Fragment;Lcom/android/settings/notification/a;)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/settingslib/applications/ApplicationsState;Landroidx/fragment/app/Fragment;Lcom/android/settings/notification/a;)V
    ...
    .line 3
    new-instance p1, Lcom/android/settings/notification/zen/g$a;

    invoke-direct {p1, p0}, Lcom/android/settings/notification/zen/g$a;-><init>(Lcom/android/settings/notification/zen/g;)V

    iput-object p1, p0, Lcom/android/settings/notification/zen/g;->h:Lcom/android/settingslib/applications/ApplicationsState$z;

    .line 4
    iput-object p4, p0, Lcom/android/settings/notification/zen/g;->a:Lcom/android/settings/notification/a;

    .line 5
    iput-object p2, p0, Lcom/android/settings/notification/zen/g;->b:Lcom/android/settingslib/applications/ApplicationsState;

    .line 6
    iput-object p3, p0, Lcom/android/settings/notification/zen/g;->g:Landroidx/fragment/app/Fragment;
    ...
    iput-object p1, p0, Lcom/android/settings/notification/zen/g;->f:Lcom/android/settingslib/applications/ApplicationsState$Session;

    :cond_0
    return-void
.end method

.method public static synthetic Q(Lcom/android/settings/notification/zen/g;Lcom/android/settingslib/applications/ApplicationsState$w;Landroidx/preference/Preference;)Z
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/settings/notification/zen/g;->T(Lcom/android/settingslib/applications/ApplicationsState$w;Landroidx/preference/Preference;)Z
...
.method public static S(Ljava/util/List;Landroidx/preference/PreferenceCategory;)Z
    .locals 5
...
.method private synthetic T(Lcom/android/settingslib/applications/ApplicationsState$w;Landroidx/preference/Preference;)Z
    .locals 2
    ...
    invoke-virtual {p2, p1}, Lt0/j;->u(Landroid/os/UserHandle;)Lt0/j;

    move-result-object p1

    iget-object p2, p0, Lcom/android/settings/notification/zen/g;->g:Landroidx/fragment/app/Fragment;

    const/4 v0, 0x0

    .line 8
    invoke-virtual {p1, p2, v0}, Lt0/j;->o(Landroidx/fragment/app/Fragment;I)Lt0/j;
...
.method public U()V
    ...
    .line 1
    iget-object v0, p0, Lcom/android/settings/notification/zen/g;->f:Lcom/android/settingslib/applications/ApplicationsState$Session;
    ...
    .line 4
    invoke-virtual {p0, v0}, Lcom/android/settings/notification/zen/g;->V(Ljava/util/List;)V
...
.method public V(Ljava/util/List;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/android/settings/notification/zen/g;->c:Landroidx/preference/PreferenceCategory;
    ...
    .line 5
    iget-object v3, p0, Lcom/android/settings/notification/zen/g;->b:Lcom/android/settingslib/applications/ApplicationsState;
    ...
    .line 6
    iget-object v3, p0, Lcom/android/settings/notification/zen/g;->a:Lcom/android/settings/notification/a;
    ...
    .line 7
    iget-object v4, p0, Lcom/android/settings/notification/zen/g;->a:Lcom/android/settings/notification/a;
    ...
    .line 10
    iget-object v5, p0, Lcom/android/settings/notification/zen/g;->c:Landroidx/preference/PreferenceCategory;
    ...
    iget-object v6, p0, Lcom/android/settings/notification/zen/g;->e:Landroid/content/Context;
    ...
    .line 13
    new-instance v2, Lcom/android/settings/notification/zen/f;

    invoke-direct {v2, p0, v1}, Lcom/android/settings/notification/zen/f;-><init>(Lcom/android/settings/notification/zen/g;Lcom/android/settingslib/applications/ApplicationsState$w;)V
    ...
    iget-object v6, v1, Lcom/android/settingslib/applications/ApplicationsState$w;->h:Ljava/lang/String;
    ...
    .line 20
    iget-object p1, p0, Lcom/android/settings/notification/zen/g;->c:Landroidx/preference/PreferenceCategory;
    ...
    iget-object v2, p0, Lcom/android/settings/notification/zen/g;->e:Landroid/content/Context;
    ...
    .line 28
    iget-object v1, p0, Lcom/android/settings/notification/zen/g;->c:Landroidx/preference/PreferenceCategory;
...
.method public displayPreference(Landroidx/preference/PreferenceScreen;)V
    ...
    iput-object v0, p0, Lcom/android/settings/notification/zen/g;->c:Landroidx/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/zen/g;->e:Landroid/content/Context;

    .line 3
    invoke-virtual {p0}, Lcom/android/settings/notification/zen/g;->U()V
