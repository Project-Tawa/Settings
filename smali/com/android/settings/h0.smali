.class public final Lcom/android/settings/h0;
.super La4/w;
.source "Utils.java"
...
.field public static final p:Ljava/lang/StringBuilder;

.field public static final q:Ljava/util/Formatter;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/h0;->p:Ljava/lang/StringBuilder;
    ...
    sput-object v1, Lcom/android/settings/h0;->q:Ljava/util/Formatter;
...
.method public static D0(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)Landroid/view/View;
    .locals 5
...
.method public static F0(Landroid/content/Context;)Z
    ...
    .line 2
    invoke-static {p0}, Lcom/android/settings/h0;->G0(Landroid/content/Intent;)Z
...
.method public static J0(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/android/settings/h0;->A0(Landroid/content/Context;)Z
...
.method public static M0(Landroid/content/Context;)Z
    ...
    const-string v0, "settings_shared_axis_enabled"
...
.method public static N(Ljava/lang/CharSequence;Ljava/lang/String;)Landroid/text/SpannableString;
    .locals 3
...
.method public static N0(Landroid/content/pm/UserInfo;Landroid/content/pm/UserInfo;)Z
    .locals 2
...
.method public static O0(Landroid/os/UserManager;Landroid/os/UserHandle;)Z
    .locals 3
...
.method public static P(Landroid/graphics/drawable/Drawable;)Landroidx/core/graphics/drawable/IconCompat;
    .locals 3
    ...
    .line 5
    :goto_1
    invoke-static {p0, v0, v1}, Lcom/android/settings/h0;->O(Landroid/graphics/drawable/Drawable;II)Landroid/graphics/Bitmap;
...
.method public static P0(Landroid/os/UserManager;Landroid/app/admin/DevicePolicyManager;Ljava/lang/String;)Z
    .locals 5
...
.method public static U0(Landroid/content/Context;)Z
    ...
    .line 1
    sget-object v0, Lcom/android/settings/h0;->o:Ljava/lang/Boolean;
    ...
    sput-object p0, Lcom/android/settings/h0;->o:Ljava/lang/Boolean;

    .line 4
    :cond_1
    sget-object p0, Lcom/android/settings/h0;->o:Ljava/lang/Boolean;
...
.method public static V(Landroid/content/Context;JJ)Ljava/lang/String;
    ...
    .line 1
    sget-object v0, Lcom/android/settings/h0;->p:Ljava/lang/StringBuilder;
    ...
    .line 3
    sget-object v3, Lcom/android/settings/h0;->q:Ljava/util/Formatter;
...
.method public static V0(Landroid/os/storage/VolumeInfo;)Z
    .locals 2
...
.method public static W(Landroid/content/Context;Landroid/graphics/drawable/Drawable;I)Landroid/graphics/drawable/Drawable;
    .locals 1
    .param p2    # I
    ...
    .line 1
    invoke-static {p1}, Lcom/android/settings/h0;->s0(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/settingslib/widget/a;-><init>(Landroid/content/Context;Landroid/graphics/drawable/Drawable;)V

    .line 4
    invoke-virtual {v0, p2}, Lcom/android/settingslib/widget/a;->a(I)V
...
.method public static W0(Landroidx/fragment/app/Fragment;Landroid/content/Intent;)V
    .locals 2
...
.method public static X(Landroid/content/Context;I)Landroid/content/pm/ApplicationInfo;
    .locals 4
...
.method public static X0(Landroid/os/storage/StorageManager;Landroid/os/Bundle;)Landroid/os/storage/VolumeInfo;
    .locals 2
    ...
    .line 3
    invoke-static {p0}, Lcom/android/settings/h0;->V0(Landroid/os/storage/VolumeInfo;)Z
...
.method public static Y(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/CharSequence;
    .locals 2
...
.method public static Y0(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;Z)V
    .locals 3
    ...
    const-string v2, "com.android.internal.R.dimen.preference_fragment_padding_bottom"
...
.method public static Z(Landroid/util/IconDrawableFactory;Landroid/content/pm/PackageManager;Ljava/lang/String;I)Landroid/graphics/drawable/Drawable;
    .locals 1
...
.method public static Z0(Landroid/app/Activity;Landroidx/lifecycle/Lifecycle;Landroid/view/View;)V
    .locals 2
...
.method public static a0(Landroid/content/Intent;)Ljava/lang/String;
    .locals 0

    .line 1
    invoke-static {p0}, La4/w;->k(Landroid/content/Intent;)I
...
.method public static a1(Landroid/widget/EditText;)V
    .locals 1
...
.method public static b1(Landroid/content/Context;Landroid/os/UserManager;I)Z
    .locals 1
...
.method public static c1(Landroid/content/Context;I)Z
    .locals 3
    ...
    .line 3
    :cond_1
    invoke-static {p0, p1}, Lcom/android/settings/h0;->M(Landroid/content/Context;I)Z
...
.method public static d1(Landroid/content/Context;Landroidx/preference/PreferenceGroup;Ljava/lang/String;I)Z
    .locals 7
...
.method public static e0(Landroid/os/UserManager;Z)I
    .locals 0
    ...
    .line 1
    invoke-static {p0}, Lcom/android/settings/h0;->m0(Landroid/os/UserManager;)Landroid/os/UserHandle;
...
.method public static f0(Landroid/content/Context;)Landroid/content/ComponentName;
    .locals 1
...
.method public static g0(Landroid/os/UserManager;Landroid/os/UserHandle;)Landroid/content/pm/UserInfo;
    .locals 2
...
.method public static h0(Landroid/content/Context;)Landroid/hardware/face/FaceManager;
    .locals 2
...
.method public static i0(Landroid/content/Context;)Landroid/hardware/fingerprint/FingerprintManager;
    .locals 2
...
.method public static j0(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/util/ArraySet;
    .locals 3
...
.method public static m0(Landroid/os/UserManager;)Landroid/os/UserHandle;
    .locals 4
...
.method public static n0(Landroid/os/UserManager;I)I
    .locals 5
...
.method public static o0(Landroid/os/UserManager;)Landroid/os/UserHandle;
    .locals 5
...
.method public static p0(Landroid/content/Context;Z)Ljava/lang/String;
    .locals 0

    if-eqz p1, :cond_0

    .line 1
    invoke-static {p0}, Lcom/android/settings/h0;->q0(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lcom/android/settings/h0;->u0(Landroid/content/Context;)Ljava/lang/String;
...
.method public static final q0(Landroid/content/Context;)Ljava/lang/String;
    .locals 6
...
.method public static r0(Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
    .locals 2
    ...
    .line 6
    :cond_1
    invoke-static {p0, p2, p1}, Lcom/android/settings/h0;->O(Landroid/graphics/drawable/Drawable;II)Landroid/graphics/Bitmap;
...
.method public static s0(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    invoke-static {p0, v0, v0}, Lcom/android/settings/h0;->r0(Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
...
.method public static t0(Landroid/os/IBinder;Landroid/os/UserManager;Landroid/os/Bundle;Landroid/os/Bundle;)Landroid/os/UserHandle;
    .locals 4
    ...
    .line 9
    invoke-static {p1, v3}, Lcom/android/settings/h0;->O0(Landroid/os/UserManager;Landroid/os/UserHandle;)Z
    ...
    .line 10
    :cond_0
    invoke-static {p3}, Lcom/android/settings/h0;->x0(Landroid/os/Bundle;)Landroid/os/UserHandle;
    ...
    .line 12
    invoke-static {p1, p0}, Lcom/android/settings/h0;->O0(Landroid/os/UserManager;Landroid/os/UserHandle;)Z
    ...
    .line 13
    :cond_1
    invoke-static {p2}, Lcom/android/settings/h0;->x0(Landroid/os/Bundle;)Landroid/os/UserHandle;
...
.method public static u0(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 1
    invoke-static {p0}, Lcom/android/settings/h0;->l0(Landroid/content/Context;)Ljava/lang/String;
...
.method public static v0(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method public static w0(Landroid/app/Activity;Ljava/lang/String;Landroid/os/Bundle;)Landroidx/fragment/app/Fragment;
    .locals 5
    ...
    invoke-static {p0, v0}, Lpf/v1;->r1(Landroid/content/Context;I)Z

    move-result v0

    if-eqz v0, :cond_2

    sget-object v0, Lw0/a;->a:Ljava/util/Map;
...
.method public static x0(Landroid/os/Bundle;)Landroid/os/UserHandle;
    .locals 3
...
.method public static y0(Landroid/content/Context;Landroid/os/Bundle;)I
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-static {p0, p1, v0}, Lcom/android/settings/h0;->z0(Landroid/content/Context;Landroid/os/Bundle;Z)I
...
.method public static z0(Landroid/content/Context;Landroid/os/Bundle;Z)I
    .locals 2

    if-nez p1, :cond_0

    .line 1
    invoke-static {p0}, Lcom/android/settings/h0;->b0(Landroid/content/Context;)I
    ...
    .line 4
    :cond_2
    invoke-static {p0, p1}, Lcom/android/settings/h0;->T(Landroid/content/Context;I)I
    ...
    .line 5
    :cond_4
    invoke-static {p0, p1}, Lcom/android/settings/h0;->S(Landroid/content/Context;I)I
