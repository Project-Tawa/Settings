...
.field private mAdaptor:Lcom/oplus/settings/adaptor/ChooseAccountPreferenceControllerAdaptor;
...
.method private getAdaptor()Lcom/oplus/settings/adaptor/ChooseAccountPreferenceControllerAdaptor;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/android/settings/accounts/ChooseAccountPreferenceController;->mAdaptor:Lcom/oplus/settings/adaptor/ChooseAccountPreferenceControllerAdaptor;

    if-nez v0, :cond_0

    .line 2
    const-class v0, Lcom/oplus/settings/adaptor/ChooseAccountPreferenceControllerAdaptor;

    invoke-static {v0}, Lcom/decouple/injector/adaptor/ClassAdaptor;->getAdaptor(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/oplus/settings/adaptor/ChooseAccountPreferenceControllerAdaptor;

    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountPreferenceController;->mAdaptor:Lcom/oplus/settings/adaptor/ChooseAccountPreferenceControllerAdaptor;
...
.method private onAuthDescriptionsUpdated()V
    ...
    .line 10
    invoke-direct {p0}, Lcom/android/settings/accounts/ChooseAccountPreferenceController;->getAdaptor()Lcom/oplus/settings/adaptor/ChooseAccountPreferenceControllerAdaptor;

    move-result-object v4

    iget-object v5, p0, Lj4/a;->mContext:Landroid/content/Context;

    invoke-virtual {v4, v5, v2}, Lcom/oplus/settings/adaptor/ChooseAccountPreferenceControllerAdaptor;->isOplusAccount(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-direct {v5, v3, v2}, Lw/l;-><init>(Ljava/lang/CharSequence;Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/oplus/settings/adaptor/ChooseAccountPreferenceControllerAdaptor;->interceptSingleProvider()Z
    ...
    invoke-virtual {v2}, Lw/l;->c()Ljava/lang/String;
    ...
    .line 18
    invoke-static {v1, v2, v3}, Lcom/android/settingslib/b;->k(Landroid/content/Context;Ljava/lang/String;I)Lcom/android/settingslib/a$a;
    ...
    .line 20
    invoke-static {v1, v2}, Lcom/android/settingslib/a;->c(Landroid/content/Context;Lcom/android/settingslib/a$a;)Landroid/content/Intent;
    ...
    invoke-virtual {v0}, Lw/l;->c()Ljava/lang/String;
    ...
    .line 27
    invoke-virtual {v2}, Lw/l;->b()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v3, v1, v4}, Lcom/oplus/settings/adaptor/ChooseAccountPreferenceControllerAdaptor;->getDrawableForPreferenceAccount(Landroid/content/Context;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v4, v2}, Lcom/android/settings/accounts/ProviderPreference;->t(I)V
...
.method public getDrawableForType(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v3, v4, v5}, Lcom/oplus/settings/adaptor/ChooseAccountPreferenceControllerAdaptor;->getDrawableForType(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
...
.method public handlePreferenceTreeClick(Landroidx/preference/Preference;)Z
    ...
    invoke-virtual {p1}, Lcom/android/settings/accounts/ProviderPreference;->u()Ljava/lang/String;
