...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lcom/android/settings/accounts/AccountDashboardFragment$a;

    const v1, 0x7f150022

    invoke-direct {v0, v1}, Lcom/android/settings/accounts/AccountDashboardFragment$a;-><init>(I)V
...
.method public static synthetic f2(Landroid/content/Context;Lcom/android/settings/SettingsPreferenceFragment;[Ljava/lang/String;Ljava/util/List;)V
    .locals 0

    .line 1
    invoke-static {p0, p1, p2, p3}, Lcom/android/settings/accounts/AccountDashboardFragment;->g2(Landroid/content/Context;Lcom/android/settings/SettingsPreferenceFragment;[Ljava/lang/String;Ljava/util/List;)V

    return-void
.end method

.method public static g2(Landroid/content/Context;Lcom/android/settings/SettingsPreferenceFragment;[Ljava/lang/String;Ljava/util/List;)V
    .locals 2
    ...
    invoke-direct {p2, p0, p1}, Lm3/b;-><init>(Landroid/content/Context;Landroidx/fragment/app/Fragment;)V
...
.method public static h2(Landroid/content/Context;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0}, Lcom/android/settings/applications/defaultapps/a;-><init>(Landroid/content/Context;)V

    invoke-interface {p1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 2
    new-instance v0, Lcom/android/settings/applications/defaultapps/b;

    invoke-direct {v0, p0}, Lcom/android/settings/applications/defaultapps/b;-><init>(Landroid/content/Context;)V
...
.method public B1(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 4
    invoke-static {p1, p0, v1, v0}, Lcom/android/settings/accounts/AccountDashboardFragment;->g2(Landroid/content/Context;Lcom/android/settings/SettingsPreferenceFragment;[Ljava/lang/String;Ljava/util/List;)V
