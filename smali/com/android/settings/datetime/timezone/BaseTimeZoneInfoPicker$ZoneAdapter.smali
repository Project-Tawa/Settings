...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Lcom/android/settings/datetime/timezone/BaseTimeZonePicker$a;Ljava/util/Locale;Ljava/lang/CharSequence;)V
    ...
    .line 1
    invoke-static {p1, p2, p4}, Lcom/android/settings/datetime/timezone/BaseTimeZoneInfoPicker$ZoneAdapter;->m(Landroid/content/Context;Ljava/util/List;Ljava/util/Locale;)Ljava/util/List;
...
.method public static m(Landroid/content/Context;Ljava/util/List;Ljava/util/Locale;)Ljava/util/List;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v3, Lcom/android/settings/datetime/timezone/a;

    .line 6
    new-instance v8, Lcom/android/settings/datetime/timezone/BaseTimeZoneInfoPicker$b;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/settings/datetime/timezone/BaseTimeZoneInfoPicker$b;-><init>(JLcom/android/settings/datetime/timezone/a;Landroid/content/res/Resources;Landroid/icu/text/DateFormat;Lcom/android/settings/datetime/timezone/BaseTimeZoneInfoPicker$a;)V
