...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lq7/h;->b(IILjava/util/function/IntFunction;Ljava/util/Comparator;)Ljava/util/Spliterator;
.end annotation
...
.method public constructor <init>(Ljava/util/Spliterator$OfInt;Ljava/util/function/IntFunction;ILjava/util/Comparator;)V
    ...
    .line 1
    iput-object p2, p0, Lq7/h$b;->b:Ljava/util/function/IntFunction;

    iput p3, p0, Lq7/h$b;->c:I

    iput-object p4, p0, Lq7/h$b;->d:Ljava/util/Comparator;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 2
    iput-object p1, p0, Lq7/h$b;->a:Ljava/util/Spliterator$OfInt;
...
.method public static synthetic a(Ljava/util/function/Consumer;Ljava/util/function/IntFunction;I)V
    ...
    invoke-static {p0, p1, p2}, Lq7/h$b;->d(Ljava/util/function/Consumer;Ljava/util/function/IntFunction;I)V
...
.method public static synthetic b(Ljava/util/function/Consumer;Ljava/util/function/IntFunction;I)V
    ...
    invoke-static {p0, p1, p2}, Lq7/h$b;->c(Ljava/util/function/Consumer;Ljava/util/function/IntFunction;I)V
...
.method public estimateSize()J
    ...
    .line 1
    iget-object v0, p0, Lq7/h$b;->a:Ljava/util/Spliterator$OfInt;
...
.method public forEachRemaining(Ljava/util/function/Consumer;)V
    ...
    iget-object v1, p0, Lq7/h$b;->b:Ljava/util/function/IntFunction;

    new-instance v2, Lq7/j;

    invoke-direct {v2, p1, v1}, Lq7/j;-><init>(Ljava/util/function/Consumer;Ljava/util/function/IntFunction;)V
...
.method public getComparator()Ljava/util/Comparator;
    ...
    .line 2
    iget-object v0, p0, Lq7/h$b;->d:Ljava/util/Comparator;
...
.method public tryAdvance(Ljava/util/function/Consumer;)Z
    ...
    invoke-direct {v2, p1, v1}, Lq7/i;-><init>(Ljava/util/function/Consumer;Ljava/util/function/IntFunction;)V
...
.method public trySplit()Ljava/util/Spliterator;
    ...
    iget-object v2, p0, Lq7/h$b;->b:Ljava/util/function/IntFunction;

    iget v3, p0, Lq7/h$b;->c:I

    iget-object v4, p0, Lq7/h$b;->d:Ljava/util/Comparator;

    invoke-direct {v1, v0, v2, v3, v4}, Lq7/h$b;-><init>(Ljava/util/Spliterator$OfInt;Ljava/util/function/IntFunction;ILjava/util/Comparator;)V
