...
.method public constructor <init>(Landroid/content/res/ColorStateList;F)V
    ...
    iput-object p2, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mPaint:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mBoundsF:Landroid/graphics/RectF;
    ...
    iput-object p1, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mBoundsI:Landroid/graphics/Rect;
...
.method private setBackground(Landroid/content/res/ColorStateList;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mBackground:Landroid/content/res/ColorStateList;
    ...
    iget-object v2, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mBackground:Landroid/content/res/ColorStateList;
...
.method private updateBounds(Landroid/graphics/Rect;)V
    ...
    .line 4
    iget-boolean p1, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mInsetForPadding:Z

    if-eqz p1, :cond_1

    .line 5
    iget p1, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mPadding:F

    iget v0, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mRadius:F

    iget-boolean v1, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mInsetForRadius:Z

    invoke-static {p1, v0, v1}, Lcom/coui/appcompat/widget/cardview/RoundRectDrawableWithShadow;->calculateVerticalPadding(FFZ)F
    ...
    .line 7
    iget-object v1, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mBoundsI:Landroid/graphics/Rect;
    ...
    .line 8
    iget-object p1, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mBoundsF:Landroid/graphics/RectF;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v2, v3, v4}, Lz6/s;->d(Landroid/graphics/RectF;F)Landroid/graphics/Path;
...
.method public onStateChange([I)Z
    ...
    .line 3
    iget-object v2, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mPaint:Landroid/graphics/Paint;

    invoke-virtual {v2, p1}, Landroid/graphics/Paint;->setColor(I)V

    .line 4
    :cond_1
    iget-object p1, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mTint:Landroid/content/res/ColorStateList;

    if-eqz p1, :cond_2

    iget-object v2, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mTintMode:Landroid/graphics/PorterDuff$Mode;

    if-eqz v2, :cond_2

    .line 5
    invoke-direct {p0, p1, v2}, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->createTintFilter(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;

    move-result-object p1

    iput-object p1, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mTintFilter:Landroid/graphics/PorterDuffColorFilter;
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 2
    iget-object v0, p0, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->mTintMode:Landroid/graphics/PorterDuff$Mode;

    invoke-direct {p0, p1, v0}, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->createTintFilter(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/coui/appcompat/widget/cardview/RoundRectDrawable;->createTintFilter(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
