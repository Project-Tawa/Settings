...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lkotlinx/coroutines/flow/FlowKt__DelayKt;->debounceInternal$FlowKt__DelayKt(Lkotlinx/coroutines/flow/Flow;Lmh/l;)Lkotlinx/coroutines/flow/Flow;
.end annotation
...
.field public final synthetic $timeoutMillisSelector:Lmh/l;
...
# direct methods
.method public constructor <init>(Lkotlinx/coroutines/flow/Flow;Lmh/l;Leh/d;)V
    .locals 0
    ...
    iput-object p2, p0, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1;->$timeoutMillisSelector:Lmh/l;
...
.method public final create(Lkotlinx/coroutines/CoroutineScope;Lkotlinx/coroutines/flow/FlowCollector;Leh/d;)Leh/d;
    ...
    iget-object v2, p0, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1;->$timeoutMillisSelector:Lmh/l;

    invoke-direct {v0, v1, v2, p3}, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1;-><init>(Lkotlinx/coroutines/flow/Flow;Lmh/l;Leh/d;)V
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1;->create(Lkotlinx/coroutines/CoroutineScope;Lkotlinx/coroutines/flow/FlowCollector;Leh/d;)Leh/d;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 4
    new-instance v15, Lnh/s;

    invoke-direct {v15}, Lnh/s;-><init>()V
    ...
    invoke-direct {v12, v1, v8}, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1$values$1;-><init>(Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1;Leh/d;)V

    const/4 v13, 0x3

    const/4 v14, 0x0

    invoke-static/range {v9 .. v14}, Lkotlinx/coroutines/channels/ProduceKt;->produce$default(Lkotlinx/coroutines/CoroutineScope;Leh/g;ILmh/p;ILjava/lang/Object;)Lkotlinx/coroutines/channels/ReceiveChannel;

    move-result-object v9

    iput-object v9, v15, Lnh/s;->a:Ljava/lang/Object;

    .line 5
    new-instance v9, Lnh/s;

    invoke-direct {v9}, Lnh/s;-><init>()V

    iput-object v8, v9, Lnh/s;->a:Ljava/lang/Object;
    ...
    .line 6
    :goto_0
    iget-object v12, v9, Lnh/s;->a:Ljava/lang/Object;
    ...
    .line 7
    new-instance v12, Lnh/r;

    invoke-direct {v12}, Lnh/r;-><init>()V

    iput-wide v5, v12, Lnh/r;->a:J

    .line 8
    iget-object v13, v9, Lnh/s;->a:Ljava/lang/Object;

    if-eqz v13, :cond_7

    .line 9
    iget-object v14, v2, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1;->$timeoutMillisSelector:Lmh/l;
    ...
    .line 10
    :cond_3
    invoke-interface {v14, v13}, Lmh/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 13
    invoke-interface {v11, v13, v2}, Lkotlinx/coroutines/flow/FlowCollector;->emit(Ljava/lang/Object;Leh/d;)Ljava/lang/Object;
    ...
    iget-object v9, v15, Lnh/s;->a:Ljava/lang/Object;

    if-eqz v9, :cond_a

    iget-wide v9, v0, Lnh/r;->a:J
    ...
    :goto_5
    invoke-static {v9}, Lgh/b;->a(Z)Ljava/lang/Boolean;
    ...
    invoke-direct {v11, v14}, Lkotlinx/coroutines/selects/SelectBuilderImpl;-><init>(Leh/d;)V
    ...
    :try_start_2
    invoke-direct/range {v9 .. v14}, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1$invokeSuspend$$inlined$select$lambda$1;-><init>(Leh/d;Lnh/s;Lnh/r;Lkotlinx/coroutines/flow/FlowCollector;Lnh/s;)V

    invoke-interface {v6, v4, v5, v3}, Lkotlinx/coroutines/selects/SelectBuilder;->onTimeout(JLmh/l;)V
    :try_end_2
    ...
    :goto_7
    :try_start_3
    iget-object v4, v3, Lnh/s;->a:Ljava/lang/Object;
    ...
    invoke-direct/range {v9 .. v14}, Lkotlinx/coroutines/flow/FlowKt__DelayKt$debounceInternal$1$invokeSuspend$$inlined$select$lambda$2;-><init>(Leh/d;Lnh/s;Lnh/r;Lkotlinx/coroutines/flow/FlowCollector;Lnh/s;)V

    invoke-interface {v6, v4, v5}, Lkotlinx/coroutines/selects/SelectBuilder;->invoke(Lkotlinx/coroutines/selects/SelectClause1;Lmh/p;)V
    :try_end_3
    ...
    invoke-static/range {v18 .. v18}, Lgh/h;->c(Leh/d;)V
